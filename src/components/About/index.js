...
import coverImage from "../../assets/images/profilepic.png";


function About() {
    return(
    <section className="title">
      <h1 class="name">About: Nathan Nitschke</h1>
      <hr></hr>
      
      <div className="row justify-content-center">
        <div className="col-10" id="about-section">
            <img class="mb-5" src="https://github.com/Nathan1133/Nathan-s-Portfolio/blob/main/assets/images/Profile%20pic1.png" alt="Nathan Nitschke"/>
        <p>
